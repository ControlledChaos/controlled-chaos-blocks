 ...
 * @subpackage controlled-chaos-blocks/frontend
 */
class Controlled_Chaos_Block_Notice_Frontend {
	...
	public function enqueue_styles() {
		...
		// Styles.
		wp_enqueue_style(
			'ccb-basic-notice-style', // Handle.
			plugin_dir_url( __FILE__ ) . 'assets/css/block-notice.min.css', // Block style CSS.
...
// Run the notice block frontend class.
$ccb_block_notice_frontend = new Controlled_Chaos_Block_Notice_Frontend();